  ...
  return (
    <section className="flex size-full flex-col gap-10 text-white">
      ...
      <div className="flex w-full flex-col gap-8 xl:max-w-[900px]">
        <Table title="Otsikko" description={`${user?.username}'s kokoushuone`} />
        <Table title="Kokous ID" description={meetingId!} />
        <Table title="Kutsulinkki" description={meetingLink} />
      </div>
      <div className="flex gap-5">
        ...
        <Button className="bg-dark-3" onClick={()=>{
          ...
          toast({title: 'Kutsulinkki kopioitu'})
        }}>
          Kopioi kutsulinkki
        </Button>
      </div>
